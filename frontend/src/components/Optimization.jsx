              ...
              <div tabIndex={0} className="collapse collapse-arrow bg-white shadow-sm rounded-box">
                ...
                <div className="collapse-title text-md font-medium">
                  <div className="flex flex-row gap-4">
                    <img src="https://picsum.photos/50/50" height={50} width={50} alt="" className="rounded-md" />
                    <div className="flex flex-col">
                      <div className="flex flex-row items-center gap-4">
                      <h4 className="text-slate-900 font-bold">Titulo de la Imagen</h4>
                      <div className="badge badge-outline">JPG</div>
                      </div>
                      <span className="text-slate-400 text-xs">an analizado a los profesionales más demandados </span>
                    </div>
                  </div>
                </div>
